 ...
 * @since 1.0
 */
public class IndexString implements Serializable, Comparable<String>, Index<String> {
    /**
     * index의 단어
     */
    ...
    public IndexString(String keyword, Long index) {
...
//                 this.indexs.add(index);
    ...
    public boolean equals(Object o) {
        ...
        IndexString index = (IndexString) o;
